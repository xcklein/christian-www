...
export function Header({ className }: { className?: string }) {
  ...
  return (
    <div className={className}>
        ...
        <div className="flex justify-between items-center">
          ...
          <div className="flex-grow-0">
            ...
            <div className="flex md:hidden">
              <IconButton variant="text" color={ isDark ? "white" : "black" } onClick={drawerOpen}>
      ...
      <Drawer placement="left" open={open} onClose={drawerClose} className="p-4 bg-palette-offwhite dark:bg-palette-grey">
